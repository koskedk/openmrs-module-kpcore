...
package org.openmrs.module.kpcore.converter;
...
public class StringToUiResourceConverterTest extends BaseModuleContextSensitiveTest {
	...
	@Test
	public void convert() {
		UiResource resource1 = converter.convert("kpcore:test/test.res");
		Assert.assertThat(resource1.getProvider(), is("kpcore"));
	...
	public void convert_shouldThrowExceptionIfNoColons() {
		converter.convert("kpcore/test.res");
	}

	@Test(expected = IllegalArgumentException.class)
	public void convert_shouldThrowExceptionIfMoreThanTwoColons() {
		converter.convert("kpcore:test:test.res");
	}
}